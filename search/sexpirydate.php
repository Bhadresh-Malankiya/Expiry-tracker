...
if(!$_SESSION["username"])
	...
	{	
		if(isset($_POST['btn']))
		   ...
		   $pro1 = mysqli_query($con,"SELECT `pname`, `pcategory`, `Quantity`, `price`, `pdate`, `pedate`, `prdate0`,  `prdate1`, `prdate2`, `prdate3`, `prdate4`,  `rdetails`, `pdesc` FROM `products` WHERE `username` =  '$username' AND `pedate`= '$search' ");
		...
		elseif(isset($_POST['btn2']))
	       ...
	       $doc1 = mysqli_query($con,"SELECT `dname`, `dcategory`, `idate`, `dedate`, `drdate0`, `drdate1`,`drdate2`,`drdate3`,`drdate4`, `ddesc` FROM `documents`  WHERE `username` =  '$username'  AND `dedate` = '$search2' ");
		   }
	  else
		{
...
?>
	...
	<form style="margin-left: 190px;" method="POST" action="sexpirydate.php" autocomplete="off">

<div class="search">
<input  style="width:290px" type="text" onfocus="(this,type='date')" onblur="(this,type='tex')" class="inputs" name="search" placeholder="Enter Expirydate of product" required>
...
<div class="search">
<input style="width:290px" class="inputs"  type="text" onfocus="(this,type='date')" onblur="(this,type='tex')" name="search2" placeholder="Enter Expirydate of document" required>
