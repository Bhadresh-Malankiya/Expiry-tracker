...
if(!$_SESSION["username"])
	...
	{	
		if(isset($_POST['btn']))
		   ...
		   $pro1 = mysqli_query($con,"SELECT `pname`, `pcategory`, `Quantity`, `price`, `pdate`, `pedate`, `prdate0`,  `prdate1`, `prdate2`, `prdate3`, `prdate4`,  `rdetails`, `pdesc` FROM `products` WHERE `username` =  '$username' AND `prdate0`= '$search' OR `prdate1`= '$search' OR `prdate2`= '$search' OR `prdate3`= '$search' OR `prdate4`= '$search' ");
	       $doc1 = mysqli_query($con,"SELECT `dname`, `dcategory`, `idate`, `dedate`, `drdate0`, `drdate1`,`drdate2`,`drdate3`,`drdate4`, `ddesc` FROM `documents`  WHERE `username` =  '$username'");
		   }
		...
		elseif(isset($_POST['btn2']))
		   ...
		   $username=$_SESSION["username"];
		   $pro1 = mysqli_query($con,"SELECT `pname`, `pcategory`, `Quantity`, `price`, `pdate`, `pedate`, `prdate0`,  `prdate1`, `prdate2`, `prdate3`, `prdate4`, `rdetails`, `pdesc` FROM `products` WHERE `username` =  '$username'");
	       $doc1 = mysqli_query($con,"SELECT `dname`, `dcategory`, `idate`, `dedate`, `drdate0`, `drdate1`,`drdate2`,`drdate3`,`drdate4`, `ddesc` FROM `documents`  WHERE `username` =  '$username'  AND `drdate0` = '$search2' OR `drdate1` = '$search2' OR `drdate2` = '$search2' OR `drdate3` = '$search2' OR `drdate4` = '$search2'");
		   }
	  else
		{
...
?>
	...
	<form style="margin-left: 190px;" method="POST" action="sreminderdate.php" autocomplete="off">

<div class="search">
<input style="width:290px" class="inputs" class="inputs"   type="text" onfocus="(this,type='date')" onblur="(this,type='tex')"  name="search" placeholder="Enter Reminderdate of product" required>
...
<div class="search">
<input style="width:310px" class="inputs"   type="text" onfocus="(this,type='date')" onblur="(this,type='tex')" name="search2" placeholder="Enter Reminderdate of document" required>
