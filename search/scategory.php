...
if(!$_SESSION["username"])
	...
	{	
		if(isset($_POST['btn']))
		   ...
		   $pro1 = mysqli_query($con,"SELECT `pname`, `pcategory`, `Quantity`, `price`, `pdate`, `pedate`, `prdate0`,  `prdate1`, `prdate2`, `prdate3`, `prdate4`,  `rdetails`, `pdesc` FROM `products` WHERE `username` =  '$username' AND `pcategory`= '$search' ");
		...
		elseif(isset($_POST['btn2']))
	       ...
	       $doc1 = mysqli_query($con,"SELECT `dname`, `dcategory`, `idate`, `dedate`, `drdate0`, `drdate1`,`drdate2`,`drdate3`,`drdate4`, `ddesc` FROM `documents`  WHERE `username` =  '$username'  AND `dcategory` = '$search2' ");
		   }
	  else
		{
...
?>
	...
	<form style="margin-left: 190px;" method="POST" action="scategory.php" autocomplete="off">

<div class="search">
<input class="inputs" type="text" name="search" placeholder="Enter category of product" required>
...
<div class="search">
<input class="inputs" type="text" name="search2" placeholder="Enter category of document" required>
