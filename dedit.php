...
$con = mysqli_connect("localhost","root","","demo");
	if(!$con)
	{
		die("Connot connet to Database :" . mysqli_connect_errno());
					...
					$drdate2= $_GET['drdate2'];
					
					
					$drdate3= $_GET['drdate3'];
					$drdate4= $_GET['drdate4'];
				    $ddesc= $_GET['ddesc'];
?>
                ...
                <div class="signup-content">
                    <form action="php/edit2.php" method="POST" id="signup-form" class="signup-form">
                       ...
                       <div class="form-group"> <p><b>set reminder</b><b style="color:red;" > *</b></p>
						   ...
						   <input type="text" onfocus="(this,type='date')" onblur="(this,type='tex')"  value="<?php echo "$drdate4"?>" placeholder="<?php echo "$drdate4"?>"  class="form-input" name="drdate4" />
                       </div>
